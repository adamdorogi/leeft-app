...
Best practices recommended by the Flutter team. These instructions were taken from [Architecture Recommendations](https://docs.flutter.dev/app-architecture/recommendations).
