...
const RoutineSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'routineExercises': PropertySchema(
      id: 1,
      name: r'routineExercises',
...
int _routineEstimateSize(
  ...
  bytesCount += 3 + object.routineExercises.length * 3;
  {
    ...
    for (var i = 0; i < object.routineExercises.length; i++) {
      final value = object.routineExercises[i];
      bytesCount +=
...
extension RoutineQueryFilter
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition>
      routineExercisesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition>
      routineExercisesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition>
      routineExercisesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension RoutineQueryObject
    on QueryBuilder<Routine, Routine, QFilterCondition> {
  QueryBuilder<Routine, Routine, QAfterFilterCondition> routineExercisesElement(
      FilterQuery<RoutineExercise> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'routineExercises');
    });
  }
}
...
extension RoutineQueryProperty
  ...
  QueryBuilder<Routine, List<RoutineExercise>, QQueryOperations>
      routineExercisesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'routineExercises');
    });
  }
}
